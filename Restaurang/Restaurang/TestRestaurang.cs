...
namespace Restaurant
{
    internal class TestRestaurang
    {
        ...
        public TestRestaurang(int guestAmount, int chefAmount, int waiterAmount, int duoTableAmount, int quadTableAmount)
        {
